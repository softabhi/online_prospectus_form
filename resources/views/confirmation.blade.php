<x-layout>
    @slot('title', 'Confirm Prospectus - Sona Devi University')
    @slot('body')
    <!-- Tailwind CSS CDN -->
    ...
    <div class="min-h-screen py-8 px-4">
        ...
        <div class="mb-8 text-center">
            <img class="h-12 mx-auto" src="{{ asset('img/SDU Logo Dark@4x.png') }}" alt="SDU">
        </div>
        ...
        <div class="max-w-5xl mx-auto bg-white rounded-[2rem] shadow-2xl flex flex-col lg:flex-row overflow-hidden border border-slate-200">
            ...
            <aside class="sidebar-compact step-gradient p-8 text-white">
                <div class="mb-10">
                    ...
                    <h1 class="text-xl font-bold mt-2">Prospectus {{ date('Y') }}</h1>
                </div>
                ...
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="mb-6 flex justify-between items-end">
                        ...
                        <div class="hidden md:block text-right">
                            ...
                            <span class="text-xs font-mono font-bold text-slate-700">{{ $txn_id }}</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('easebuzz') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="firstname" value="{{ $data->prospectus_applicant_name }}" class="input-readonly" readonly>
                            </div>

                            <div>
                                <label class="label-style">Email Address</label>
                                <input type="email" name="email" value="{{ $data->prospectus_emailid }}" class="input-readonly" readonly>
                            </div>

                            <div>
                                <label class="label-style">Father's Name</label>
                                <input type="text" name="udf1" value="{{ $data->prospectus_father_name }}" class="input-readonly" readonly>
                            </div>

                            <div>
                                <label class="label-style">Mobile Number</label>
                                <input type="text" name="phone" value="{{ $data->mobile }}" class="input-readonly" readonly>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="udf2" value="{{ $course->course_name ?? 'N/A' }}" class="input-readonly" readonly>
                            </div>

                            <div>
                                <label class="label-style">Academic Session</label>
                                <input type="text" name="udf3" value="{{ $data->prospectus_session }}" class="input-readonly" readonly>
                            </div>
                        ...
                        <div class="amount-highlight p-5 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                <span class="text-2xl font-black text-amber-900">₹{{ session('prospectus_money') }}</span>
                                <input type="hidden" name="amount" value="{{ session('prospectus_money') }}">
