<x-layout>
    @slot('title', 'OTP Verification - Sona Devi University')
    @slot('body')
    <!-- Tailwind CSS CDN -->
    ...
    <div class="min-h-screen">
        ...
        <div class="py-6 shadow-xl text-center">
            <img class="h-14 mx-auto transition-transform hover:scale-105 duration-300" src="{{ asset('img/SDU Logo Dark@4x.png') }}" alt="SDU">
        </div>
                        ...
                        <div class="mb-10 text-center lg:text-left">
                            ...
                            <p class="text-slate-500 mt-3 leading-relaxed">
                                ...
                                <span class="text-slate-900 font-bold">
                                    @if (session()->has('phone')) {{ session()->get('phone') }} @else +91-XXXXXXXXXX @endif
                                </span>
                            </p>
                        </div>

                        <form action="{{ route('admission.otp_verify') }}" method="POST" class="space-y-8">
                            @csrf
