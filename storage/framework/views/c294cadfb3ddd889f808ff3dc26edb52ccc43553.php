                            ...
                            <div class="input__container prospectus">
                                <form method="POST" action="<?php echo e(route('prospectus')); ?>">
                                    ...
                                    <div class="  mb-3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                             ...
                                             <div class="form-group col-md-3">
                                                <label for="">Counsellor By</label>
                                                <input  type="text" id="" name="councellor_name" placeholder="Counselor Name"
                                                    class="form-control" value="">
                                            </div>
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input required id="prospectus_state" value="" class="form-control"
                                    ...
                                    <div class="form-group  col-md-12">
                                        <span style="color:#FFFF00;"><b>Note : </b>For Admission Related Query, Please contact us on this number - +91-9263783020
                                            </span>
                                            <br>
                                        <span style="color:#c70013;"><b>Note : </b>If you are facing some Technical Issues
                                            during
                                            form submission, Feel Free to contact us on this number - +91-9060908201,
                                            +91-9123227267</span>
                                    </div>
                                </form>
                            </div>
...
<?php /**PATH /home/u517204354/domains/sonadeviuniversity.ac.in/public_html/admissions/resources/views/index.blade.php ENDPATH**/ ?>