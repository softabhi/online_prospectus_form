...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Application Receipt - Sona Devi University'); ?>
    <?php $__env->slot('body'); ?>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="no-print flex justify-between items-center mb-6 bg-white p-4 rounded-xl shadow-sm">
            <a href="<?php echo e(url('/')); ?>" class="text-slate-600 flex items-center gap-2 hover:text-slate-900 transition-colors">
        ...
        <div class="receipt-card p-6 md:p-10">
            ...
            <div class="text-center border-b border-slate-100 pb-8 mb-6">
                <img class="h-16 mx-auto mb-4" src="<?php echo e(asset('img/SDU Logo Dark@4x.png')); ?>" alt="SDU Logo">
                ...
                <div class="mt-2 inline-block bg-slate-100 px-4 py-1 rounded-full">
                    ...
                    <span class="text-xs font-black text-slate-800"><?php echo e($data->prospectus_no); ?></span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 px-2">
                <div>
                    ...
                    <p class="data-value"><?php echo e($data->prospectus_session); ?></p>
                </div>
                <div class="col-span-1 md:col-span-2">
                    <p class="data-label">Course Applied</p>
                    <p class="data-value"><?php echo e(DB::table('tbl_course')->where('course_id', $data->prospectus_course_name)->first()->course_name); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-4 px-2">
                <div>
                    ...
                    <p class="data-value"><?php echo e($data->prospectus_applicant_name); ?></p>
                </div>
                <div>
                    <p class="data-label">Mobile Number</p>
                    <p class="data-value"><?php echo e($data->mobile); ?></p>
                </div>
                <div>
                    <p class="data-label">Email ID</p>
                    <p class="data-value"><?php echo e($data->prospectus_emailid); ?></p>
                </div>
                <div>
                    <p class="data-label">Father's Name</p>
                    <p class="data-value"><?php echo e($data->prospectus_father_name); ?></p>
                </div>
                <div>
                    <p class="data-label">Mother's Name</p>
                    <p class="data-value"><?php echo e($data->prospectus_mother_name); ?></p>
                </div>
                <div>
                    <p class="data-label">Gender / DOB</p>
                    <p class="data-value"><?php echo e($data->prospectus_gender); ?> | <?php echo e($data->prospectus_dob); ?></p>
                </div>
                <div>
                    <p class="data-label">Referred By</p>
                    <p class="data-value"><?php echo e($data->revert_by ?: 'N/A'); ?></p>
                </div>
                <div>
                    <p class="data-label">Counsellor</p>
                    <p class="data-value"><?php echo e($data->councellor_name ?: 'N/A'); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-4 px-2">
                <div class="md:col-span-2">
                    ...
                    <p class="data-value"><?php echo e($data->prospectus_address); ?></p>
                </div>
                <div>
                    <p class="data-label">Country</p>
                    <p class="data-value"><?php echo e($data->prospectus_country); ?></p>
                </div>
                <div>
                    <p class="data-label">City</p>
                    <p class="data-value"><?php echo e($data->prospectus_city); ?></p>
                </div>
                <div>
                    <p class="data-label">State</p>
                    <p class="data-value"><?php echo e($data->prospectus_state); ?></p>
                </div>
                <div>
                    <p class="data-label">Postal Code</p>
                    <p class="data-value"><?php echo e($data->prospectus_postal_code); ?></p>
                </div>
            </div>
            ...
            <div class="bg-slate-50 border border-slate-100 rounded-xl p-4 grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-4">
                <div>
                    ...
                    <p class="data-value font-bold text-blue-600"><?php echo e($data->prospectus_payment_mode); ?></p>
                </div>
                <div>
                    <p class="data-label">Total Amount</p>
                    <p class="data-value font-bold text-slate-900">₹<?php echo e(number_format($data->prospectus_rate, 2)); ?></p>
                </div>
                <div>
                    <p class="data-label">Transaction Date</p>
                    <p class="data-value"><?php echo e($data->transaction_date); ?></p>
                </div>
                <div class="md:col-span-1">
                    <p class="data-label">Transaction ID</p>
                    <p class="data-value font-mono text-xs"><?php echo e($data->transaction_id); ?></p>
                </div>
                <div class="md:col-span-2">
                    <p class="data-label">Easebuzz / Reference ID</p>
                    <p class="data-value font-mono text-xs"><?php echo e($data->easebuzz_id); ?></p>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/admissions/resources/views/print.blade.php ENDPATH**/ ?>