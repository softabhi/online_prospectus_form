...
<?php $component->withAttributes([]); ?>
    ...
    <div class="min-h-screen pb-7">
        ...
        <div class="py-4 shadow-xl text-center">
            <img class="h-14 mx-auto" src="<?php echo e(asset('img/SDU Logo Dark@4x.png')); ?>" alt="SDU">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 mt-8">
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <!-- Main Form Area -->
                <div class="lg:w-3/4">
                    <form role="form" action="<?php echo e(route('admission.admission_form')); ?>" method="POST" id="admission_form" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div id="error_section"></div>
                        <input type="hidden" name="approval" value="not">
                        <input type="hidden" name="admission_program_type" value="<?php echo e($data->prospectus_program_type); ?>">
                        ...
                        <div class="form-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                ...
                                <div>
                                    ...
                                    <input id="form_no" readonly value="<?php echo e($data->prospectus_no); ?>" type="text" name="admission_form_no" class="input-field bg-blue-50 text-blue-700 font-bold border-blue-200" required>
                                </div>
                                <div>
                        ...
                        <div class="form-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <input id="first_name" type="text" value="<?php echo e($data->prospectus_applicant_name); ?>" name="admission_first_name" class="input-field" required>
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div>
                                    ...
                                    <?php $p_course = DB::table('tbl_course')->where('course_id', $data->prospectus_course_name)->first(); ?>
                                    <input type="hidden" name="admission_course_name" value="<?php echo e($data->prospectus_course_name); ?>">
                                    <input type="text" class="input-field bg-slate-50 font-bold border-slate-200" disabled value="<?php echo e($p_course->course_name); ?>">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input id="dob" value="<?php echo e($data->prospectus_dob); ?>" type="date" name="admission_dob" class="input-field bg-slate-50 border-slate-200" required>
                                </div>
                            </div>
                        ...
                        <div class="form-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div>
                                    ...
                                    <input readonly id="mobile_no" type="text" value="<?php echo e($data->mobile); ?>" name="admission_mobile_student" class="input-field bg-slate-50 border-slate-200">
                                </div>
                                <div>
                                    <label class="label-style">Email (Student) <span class="text-red-500">*</span></label>
                                    <input readonly id="email_id" value="<?php echo e($data->prospectus_emailid); ?>" type="email" name="admission_emailid_student" class="input-field bg-slate-50 border-slate-200">
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                <div>
                                    ...
                                    <input readonly type="text" value="<?php echo e($data->prospectus_emailid); ?>" name="admission_username" class="input-field bg-slate-50 border-slate-200 text-slate-400">
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                ...
                                <div class="flex justify-center md:justify-start">
                                    <img src="<?php echo e(asset('img/user.png')); ?>" id="photoBrowser" class="w-20 h-20 rounded-lg border border-slate-200 object-cover shadow-sm bg-slate-50">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                                <div>
                                    ...
                                    <input id="postal_code" type="text" onkeyup="check_pincode(this.value)" value="<?php echo e($data->prospectus_postal_code); ?>" name="admission_pin_code" class="input-field" required placeholder="6 Digit PIN">
                                </div>
                                <div>
                                    <label class="label-style">Country</label>
                                    <input readonly id="country" type="text" class="input-field bg-slate-50 border-slate-200 font-medium" value="<?php echo e($data->prospectus_country); ?>">
                                </div>
                                <div>
                                    <label class="label-style">State</label>
                                    <input readonly id="state" type="text" name="admission_state" class="input-field bg-slate-50 border-slate-200 font-medium" value="<?php echo e($data->prospectus_state); ?>">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input id="city" type="text" name="admission_city" class="input-field" value="<?php echo e($data->prospectus_city); ?>">
                                </div>
                                <div>
                            ...
                            <div class="w-full">
                                ...
                                <textarea id="address" name="admission_residential_address" class="input-field h-20 py-2"  required><?php echo e($data->prospectus_address); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                                <div>
                                    ...
                                    <input id="mother_name" type="text" name="admission_mother_name" class="input-field" required value="<?php echo e($data->prospectus_father_name); ?>">
                                </div>
                                <div>
                                    <label class="label-style">Father's Name <span class="text-red-500">*</span></label>
                                    <input id="father_name" type="text" name="admission_father_name" class="input-field" required value="<?php echo e($data->prospectus_mother_name); ?>">
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/admissions/resources/views/admission_form.blade.php ENDPATH**/ ?>