                        ...
                        <div class="card">
                            <div class="card-content " id="print_pdf_file">
                                <div class="row container">
                                    ...
                                    <div class="row container ">
                                        <div class="col-10">
                                            <strong> Prospectus No : <?php echo e($data->prospectus_no); ?></strong>
                                        </div>
                                        <div class="col-2">
                            ...
                            <div class="invoice-product-details">
                                ...
                                <div class="row container">
                                    ...
                                    <div class="col-sm-3" style="width: 25%">
                                       ...
                                       <div class="col-sm-3" style="width: 25%">
                                        <p><strong>Counsellor By</strong></p>
                                        <p><?php echo e($data->councellor_name); ?></p>
                                    </div>
                                </div>
                                <div class="row container">
                                    <div class="col-sm-4" style="width: 33.33%">
...
<?php /**PATH /home/u517204354/domains/sonadeviuniversity.ac.in/public_html/admissions/resources/views/print.blade.php ENDPATH**/ ?>