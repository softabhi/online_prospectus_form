...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Sona Devi University - Prospectus Form'); ?>
    <?php $__env->slot('body'); ?>
    <!-- Tailwind CSS CDN -->
        ...
        <div class="max-w-7xl mx-auto px-4 py-10">
            <div class="bg-white rounded-3xl shadow-2xl flex flex-col lg:flex-row overflow-hidden border border-slate-100">
                ...
                <div class="lg:w-1/3 step-gradient p-10 text-white flex flex-col justify-between">
                    <div>
                        <div class="mb-12">
                            <h1 class="text-3xl font-bold tracking-tight mb-2">Prospectus Form <?php echo e(date('Y')); ?></h1>
                ...
                <div class="lg:w-2/3 p-8 md:p-12 lg:p-16">
                    ...
                    <form method="POST" action="<?php echo e(route('prospectus')); ?>" class="space-y-10">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input required readonly id="program_type" name="prospectus_program_type" class="w-full h-8 px-4 rounded-xl border border-slate-200 bg-slate-100" value="<?php echo e(old('prospectus_program_type')); ?>" placeholder="Auto-filled">
                                </div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/prospectus-new-version/resources/views/index.blade.php ENDPATH**/ ?>