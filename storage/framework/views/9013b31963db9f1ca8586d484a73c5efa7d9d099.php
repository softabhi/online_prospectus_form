                                    ...
                                    <div class="col-sm-12" style="text-align: center; width: 100%;">
                                        <nav class="whitenav" style="background-color: white; box-shadow: none;">
                                            <div class="nav-wrapper">
                                                <img width="250" class="img-fluid" src="img/SDU Logo Dark@4x.png"
                                                    alt="Sona Devi University Logo">
                                            </div>
                                        </nav>
...
<?php /**PATH /var/www/html/prospectus/resources/views/print.blade.php ENDPATH**/ ?>