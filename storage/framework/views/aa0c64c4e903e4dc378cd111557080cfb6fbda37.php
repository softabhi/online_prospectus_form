...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Document Upload - Sona Devi University'); ?>
    <?php $__env->slot('body'); ?>
...
<!-- bg-slate-900 this is black color code  -->
    <div class="min-h-screen pb-20">
        ...
        <div class=" py-4 shadow-xl text-center">
            <img class="h-10 mx-auto" src="<?php echo e(asset('img/SDU Logo Dark@4x.png')); ?>" alt="SDU">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 mt-8">
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <!-- Main Content Area -->
                <div class="lg:w-3/4">
                    <form role="form" action="<?php echo e(route('admission.admission_document')); ?>" method="POST" id="admission_form" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/admissions/resources/views/admission_document.blade.php ENDPATH**/ ?>