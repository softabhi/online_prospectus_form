                    ...
                    <div class="right__container">
                        <fieldset id="form2">
                            <div class="sub__title__container ">
                                ...
                                <p class="text-danger "> <b> Note :</b> Please check all information are correct <i
                                        class='fa fa-warning' aria-hidden="true"></i></p>
                            </div>
                             <div class="form-group  col-md-12">
                            <span style="color:#FFFF00;"><b>Note : </b>भुगतान के बाद, कृपया कुछ सेकंड प्रतीक्षा करें। जब तक रशीद प्रताप न हों।
                            </span>`
                            <br>
                            <span style="color:#c70013;"><b>Note : </b>After payment,please wait for some seconds until receipt is not displayed.</span>
                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input class="form-control" id="amount" name="amount"
                                                            value="<?php echo e(session('prospectus_money')); ?>" readonly="">
                                            ...
                                            <div class="form-group  col-md-12">
                                                <span style="color:#c70013;"><b>Note : </b>If you are facing some Technical
                                                    Issues during
                                                    form submission, Feel Free to contact us on this number - +91-9060908201, +91-9123227267</span>
...
<?php endif; ?>
<?php /**PATH /home/u517204354/domains/sonadeviuniversity.ac.in/public_html/admissions/resources/views/confirmation.blade.php ENDPATH**/ ?>