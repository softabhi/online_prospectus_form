...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('title', 'Admission Complete - Sona Devi University'); ?>
    <?php $__env->slot('body'); ?>
    ...
    <div class="min-h-screen pb-20">
        ...
        <div class="py-4 shadow-xl text-center">
            <img class="h-16 mx-auto" src="<?php echo e(asset('img/SDU Logo Dark@4x.png')); ?>" alt="SDU">
        </div>
                ...
                <div class="lg:w-3/4 flex items-center justify-center">
                    <div class="success-card w-full max-w-2xl">
                        ...
                        <div class="mb-8 relative flex justify-center">
                            ...
                            <img src="<?php echo e(asset('img/succlog.png')); ?>" alt="Success" class="w-32 h-32 relative z-10 confetti-icon drop-shadow-2xl">
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-slate-600 max-w-md mx-auto leading-relaxed">
                                We have successfully received your admission form for the <span class="text-slate-900 font-bold"><?php echo e(date('Y')); ?></span> session. Your profile is now under review by our academic board.
                            </p>
                        </div>
                        ...
                        <div class="mt-12 flex flex-col md:flex-row gap-4 justify-center">
                            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 px-10 h-12 rounded-xl font-bold bg-slate-900 text-white hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20">
...
<?php endif; ?><?php /**PATH /opt/lampp/htdocs/admissions/resources/views/thankyou.blade.php ENDPATH**/ ?>